  ...
  dashboard_body = jsonencode({
    widgets = [
      ...
      },
      {
        ...
        properties = {
          metrics = [
            ["AWS/ApiGateway", "2XX", "ApiName", var.api_gateway_name]
          ],
      ...
      },
      {
        ...
        properties = {
          metrics = [
            ["AWS/ApiGateway", "ThrottleCount", "ApiName", var.api_gateway_name]
          ],
      ...
      },
      {
        ...
        properties = {
          metrics = [
            ["AWS/ApiGateway", "DataProcessed", "ApiName", var.api_gateway_name]
          ],
